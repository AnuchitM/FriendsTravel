        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12 col-lg-4">
                    <label for="txtDetail">ชื่อกิจกรรม : </label>
                ...
                <div class="col-md-12 col-lg-4">
                    <label for="txtPeople">จำนวน (คน) : </label>
                    <input id="txtPeople" type="text" onkeypress="return validate_int()" class="form-control" />
                </div>
            </div>
            <div class="row pt-2">
                <div class="col-md-12 col-lg-4">
                    <label for="txtDetail">รายละเอียด : </label>
                    <input id="txtDetail" type="text" class="form-control" />
                </div>
