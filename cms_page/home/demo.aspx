<%@ Page Title="" Language="C#" MasterPageFile="~/master_page/page_list.Master" AutoEventWireup="true" CodeBehind="demo.aspx.cs" Inherits="FriendsTravel.home.demo" %>

<asp:Content ID="ContentHead" ContentPlaceHolderID="MainContentHead" runat="server">
   
     <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
    <script src="../project_theme/AdminLTE-3.2.0/dist/js/pages/dashboard.js"></script>
